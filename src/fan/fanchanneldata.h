...
#include "src/softwareauto/fanramp.h"
#include "src/averager.h"
...
{
    return m_manualRPM != manualRPMNotSetValue && m_manualRPM != manualRPMNotSetValue_Preferred;
}
...
{
    return !(value == manualRPMNotSetValue || value == manualRPMNotSetValue_Preferred);
}
